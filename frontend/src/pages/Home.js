...
const heroSlides = [
  ...
  },
  {
    ...
    img: '/assets/real_mahindra_scorpio.png',
    label: 'Car Loan',
    rate: 'from 7.5% p.a.',
    link: '/auto-loan',
  ...
  },
  {
    ...
    tag: 'Pre-Owned Cars',
    img: '/assets/real_toyota_fortuner.png',
    label: 'Used Car Loan',
    rate: 'from 9% p.a.',
    link: '/used-car-loan',
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-10">
            {[
              ...
              <motion.div key={i}
                ...
                <div>
                  <h3 className="text-base font-bold mb-1" style={{ color: "var(--text-primary)" }}>{item.title}</h3>
