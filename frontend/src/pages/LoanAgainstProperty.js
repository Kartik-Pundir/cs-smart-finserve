  ...
  return (
    <div className="min-h-screen" style={{ background: '#f8f7f4' }}>
      ...
      <section className="relative pt-40 pb-24 bg-cover bg-center"
        style={{ backgroundImage: 'linear-gradient(135deg, rgba(26,26,46,0.65) 0%, rgba(192,57,43,0.60) 100%), url(https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=1400&q=80)' }}>
      ...
      <section className="py-20" style={{ background: '#f8f7f4' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {['Loan up to 70% of Property Value', 'Rates Starting from 8.5%', 'Tenure up to 15 Years', 'Residential & Commercial Property', 'Balance Transfer Available', 'Minimal Documentation'].map((feature, i) => (
